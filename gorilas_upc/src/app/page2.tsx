...
export default function Home2() {
    return (
        <div className="bg-heroImage2 h-screen w-screen bg-cover bg-center">
            <div className="h-screen w-screen bg-black opacity-[0.3]">
            </div>
            <div className="absolute overflow-hidden z-10 top-[50%] w-screen h-16vw gap-y-0">
                <span className="aa text-[#ffffff] font-bebas-neue">
            ...
            <div className="absolute overflow-hidden z-10 top-[50%] w-screen h-16vw gap-y-0">
                <span className="aa2 text-[#ee7c31] font-bebas-neue">
